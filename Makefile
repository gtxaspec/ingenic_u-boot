...
LIBS-$(CONFIG_JZ_ADC) += drivers/adc/libadc.o
...
LIBS-$(CONFIG_JZ_SFC) += drivers/mtd/devices/jz_sfc_v1/libsfc.o
LIBS-$(CONFIG_SFC_NAND_COMMAND) += drivers/mtd/devices/jz_sfc_v1/libsfc.o
LIBS-$(CONFIG_JZ_SFC_CDT) += drivers/mtd/devices/jz_sfc_v2/libsfc.o
