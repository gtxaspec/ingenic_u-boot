...
#if defined(CONFIG_FAST_BOOT) || defined (CONFIG_YMODEM_NO_PRINTF) || defined(CONFIG_SIMULATION)
#undef DEBUG /*When the conditions are met, there should be no debug information*/
