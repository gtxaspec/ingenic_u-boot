...
#define CONFIG_SYS_MPLL_MNOD		(((0x46) << 20) | ((0x0) << 14) | ((0x1) << 11) | ((0x0) << 7) | ((0x3) << 4))
...
/* DEBUG ETHERNET */
#define CONFIG_SERVERIP		10.3.2.2
#define CONFIG_IPADDR		10.3.20.151
#define CONFIG_GATEWAYIP	10.3.20.1
 ...
 */
#define CONFIG_SLCD_RST_PIN			GPIO_PA(16)
#define CONFIG_SLCD_CS_PIN			GPIO_PD(10)
#define CONFIG_SLCD_RD_PIN			GPIO_PD(12)
#define CONFIG_SLCD_BL_PIN			GPIO_PC(17)	// backlight
#endif
...
#define CONFIG_GPIO_LCD_CS     GPIO_PD(10)
#define CONFIG_GPIO_LCD_RD     GPIO_PD(12)
#define CONFIG_GPIO_LCD_RST     GPIO_PA(16)
#define CONFIG_GPIO_BL_PWR_EN   GPIO_PC(17)
#endif
