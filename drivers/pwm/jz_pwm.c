...
#define PWM_CLK_RATE 48000000

struct jz_gpio_func_def pwm_pins[PWM_CHN_NUM] = {
	// [0] = {.port = GPIO_PORT_B, .func = GPIO_FUNC_0, .pins =17 },
	[0] = {.port = GPIO_PORT_C, .func = GPIO_FUNC_2, .pins =15 },

	// [1] = {.port = GPIO_PORT_B, .func = GPIO_FUNC_0, .pins =18 },
	[1] = {.port = GPIO_PORT_C, .func = GPIO_FUNC_2, .pins =16 },

	// [2] = {.port = GPIO_PORT_B, .func = GPIO_FUNC_2, .pins =8  },
	[2] = {.port = GPIO_PORT_C, .func = GPIO_FUNC_2, .pins =17 },

	// [3] = {.port = GPIO_PORT_B, .func = GPIO_FUNC_2, .pins =9  },
	[3] = {.port = GPIO_PORT_C, .func = GPIO_FUNC_2, .pins =18 },

	// [4] = {.port = GPIO_PORT_B, .func = GPIO_FUNC_2, .pins =13 },
	[4] = {.port = GPIO_PORT_D, .func = GPIO_FUNC_2, .pins =9  },

	// [5] = {.port = GPIO_PORT_B, .func = GPIO_FUNC_2, .pins =14 },
	[5] = {.port = GPIO_PORT_D, .func = GPIO_FUNC_2, .pins =10 },

	// [6] = {.port = GPIO_PORT_B, .func = GPIO_FUNC_2, .pins =15 },
	[6] = {.port = GPIO_PORT_D, .func = GPIO_FUNC_2, .pins =11 },

	// [7] = {.port = GPIO_PORT_B, .func = GPIO_FUNC_2, .pins =16 },
	[7] = {.port = GPIO_PORT_D, .func = GPIO_FUNC_2, .pins =12 },
};
